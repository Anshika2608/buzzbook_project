...
const MovieCardSkeleton = () => (
  <div className="animate-pulse">
    <div className="rounded-2xl bg-slate-800 aspect-[2/3] mb-3" />
...
const NowShowing = () => {
  ...
  const { city, movies, isLoadingMovies } = useLocation()
  ...
  return (
    <div className="relative z-10 px-4 py-8 sm:px-6 sm:py-12 md:px-10 lg:px-16">
      ...
      <header className="mb-10 text-center sm:mb-14">
        ...
        <h2 className="text-3xl font-bold text-transparent h-20 sm:h-16 bg-gradient-to-r from-white via-slate-200 to-slate-400 bg-clip-text sm:text-4xl md:text-5xl">
