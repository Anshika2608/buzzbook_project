...
//   // fetch theatres when movieName & city are available
//   useEffect(() => {
//     if (city && movieName) {
...
//   // fetch price ranges when movieName & city available
//   useEffect(() => {
//     if (movieName && city) {
//       fetchPriceRanges(movieName, city);
//       console.log("hey", priceRanges);
//     }
//   }, [movieName, city]);
...
//               <Card
//                 key={theatre._id}
//                 className="rounded-2xl border-slate-700/50 bg-slate-800/60 backdrop-blur-xl transition-all hover:shadow-xl"
//               >
...
//                           <p className="text-xs text-green-400">Cancellation available</p>
//                         ):(
//                           <p className="text-xs text-yellow-300">Cancellation Not available</p>
//                         )
//                       }
//                       <p className="text-xs text-slate-400">Contact: {theatre.contact}</p>
//                       {/* Amenities */}
            ...
            theatres.map((theatre) => (
              ...
              >
                <div className="flex flex-col gap-6 lg:flex-row lg:justify-between">
                  ...
                  <div className="flex w-full flex-col justify-between gap-4 lg:w-fit lg:flex-shrink-0">
                    {/* Cancellation Policy */}
                    <div className="flex items-center gap-2 rounded-xl bg-slate-700/50 p-2 text-xs text-slate-300">
                      {theatre.cancellationAvailable ? (
                        <>
